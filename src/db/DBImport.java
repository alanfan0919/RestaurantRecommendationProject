	...
	public static void main(String[] args) {
	 	 try {
			//Step 1: Initialize the driver and connect to a SQL server
	 		 ...
	 		 try {
	 			 conn = DriverManager
	 					 .getConnection("jdbc:mysql://localhost:3306/mysql?", //mysql is database name
	 							 "root", "root");
	 			 /*conn = DriverManager
	 					 .getConnection("jdbc:mysql://localhost:3306/mysql?" //mysql is database name
			 ...
			 sql = "DROP TABLE IF EXISTS USER_CATEGORY_HISTORY";
	  		 ...
	  		 //Step 3: insert data
	  		 //3.1 insert restaurants data
	  		 BufferedReader reader = new BufferedReader(new FileReader(
	  				 "D://eclipse workspace/yelp_dataset_challenge_academic_dataset/yelp_academic_dataset_business.json"));
	  		 while ((line = reader.readLine()) != null) {
	  			 ...
	  			 String imageUrl = "http://www.example.com/img.JPG"; //dummy url
	  		 ...
	  		 reader.close();
	  		//3.1 insert reviews data
	  		 /*reader = new BufferedReader(new FileReader(
	  				"D://eclipse workspace/yelp_dataset_challenge_academic_dataset/yelp_academic_dataset_review.json"));
